...
## Выводы
- `BDT` универсальный инструмент, который заслуживает внимания. Универсальный потому, что формирует общий единообразный подход к трансформации данных, не зависимо на какой базе данных оно построено (Postgres, GreenPlum, ClickHouse, S3 . . .)
